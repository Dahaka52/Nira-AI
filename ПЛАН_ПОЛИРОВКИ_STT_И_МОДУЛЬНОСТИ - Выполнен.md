...
## 10. Статус выполнения (2026-03-04)

1. Шаг 0: выполнен частично (подготовлены инструменты smoke/regression; исторический baseline до рефакторинга не восстановим ретроспективно).
2. Шаг 1: выполнен.
3. Шаг 2: выполнен.
4. Шаг 3: выполнен.
5. Шаг 4: выполнен.
...
9. Шаг 8: выполнен.
10. Шаг 9: выполнен.
11. Шаг 10: пропущен по ТЗ.
12. Шаг 11: выполнен (добавлены `src/tools/stt_smoke.py` и `src/tools/stt_regression.py`).
